...
| --- | ---: | ---: | ---: |
| `decomposition_anti_sycophancy` | 27 | 50 | 54.0% |
| `decomposition_category_axis` | 25 | 50 | 50.0% |
| `decomposition_combined` | 15 | 50 | 30.0% |
| `decomposition_general_evaluative` | 19 | 50 | 38.0% |
| `decomposition_harm_reduction` | 27 | 50 | 54.0% |
| `decomposition_persona_honesty` | 24 | 50 | 48.0% |
| `decomposition_truthfulness` | 18 | 50 | 36.0% |
| `direct_anti_sycophancy` | 29 | 50 | 58.0% |
| `direct_category_axis` | 24 | 50 | 48.0% |
| `direct_combined` | 18 | 50 | 36.0% |
| `direct_general_evaluative` | 27 | 50 | 54.0% |
| `direct_harm_reduction` | 28 | 50 | 56.0% |
| `direct_persona_honesty` | 13 | 50 | 26.0% |
| `direct_truthfulness` | 25 | 50 | 50.0% |
| `length` | 33 | 50 | 66.0% |
| `random` | 16 | 50 | 32.0% |
...
| `anti_sycophancy` | `direct_combined` | 7 | 10 | 70.0% |
| `anti_sycophancy` | `decomposition_combined` | 2 | 10 | 20.0% |
| `anti_sycophancy` | `direct_category_axis` | 8 | 10 | 80.0% |
| `anti_sycophancy` | `decomposition_category_axis` | 7 | 10 | 70.0% |
...
| `factuality` | `direct_combined` | 0 | 5 | 0.0% |
| `factuality` | `decomposition_combined` | 0 | 5 | 0.0% |
| `factuality` | `direct_category_axis` | 0 | 5 | 0.0% |
| `factuality` | `decomposition_category_axis` | 0 | 5 | 0.0% |
...
| `general_helpfulness` | `decomposition_combined` | 3 | 10 | 30.0% |
| `general_helpfulness` | `direct_category_axis` | 6 | 10 | 60.0% |
| `general_helpfulness` | `decomposition_category_axis` | 7 | 10 | 70.0% |
...
| `harmful_request` | `decomposition_combined` | 1 | 8 | 12.5% |
| `harmful_request` | `direct_category_axis` | 1 | 8 | 12.5% |
| `harmful_request` | `decomposition_category_axis` | 1 | 8 | 12.5% |
...
| `persona_honesty` | `direct_combined` | 6 | 10 | 60.0% |
| `persona_honesty` | `decomposition_combined` | 5 | 10 | 50.0% |
| `persona_honesty` | `direct_category_axis` | 4 | 10 | 40.0% |
| `persona_honesty` | `decomposition_category_axis` | 7 | 10 | 70.0% |
...
- Scores CSV: `notes/research_cycles/cycle_001_next/pilot_50_cheap_baselines/scores.csv`
- Scores JSON: `notes/research_cycles/cycle_001_next/pilot_50_cheap_baselines/scores.json`
- Selections CSV: `notes/research_cycles/cycle_001_next/pilot_50_cheap_baselines/selections.csv`
- Blind packet: `notes/research_cycles/cycle_001_next/pilot_50_cheap_baselines/blind_review_packet.jsonl`
- Blind packet key: `notes/research_cycles/cycle_001_next/pilot_50_cheap_baselines/blind_review_packet_key.json`
