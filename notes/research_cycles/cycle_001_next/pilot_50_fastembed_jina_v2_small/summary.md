...
| --- | ---: | ---: | ---: |
| `decomposition_anti_sycophancy` | 12 | 50 | 24.0% |
| `decomposition_category_axis` | 15 | 50 | 30.0% |
| `decomposition_combined` | 15 | 50 | 30.0% |
| `decomposition_general_evaluative` | 14 | 50 | 28.0% |
| `decomposition_harm_reduction` | 20 | 50 | 40.0% |
| `decomposition_persona_honesty` | 23 | 50 | 46.0% |
| `decomposition_truthfulness` | 10 | 50 | 20.0% |
| `direct_anti_sycophancy` | 5 | 50 | 10.0% |
| `direct_category_axis` | 13 | 50 | 26.0% |
| `direct_combined` | 11 | 50 | 22.0% |
| `direct_general_evaluative` | 7 | 50 | 14.0% |
| `direct_harm_reduction` | 19 | 50 | 38.0% |
| `direct_persona_honesty` | 22 | 50 | 44.0% |
| `direct_truthfulness` | 15 | 50 | 30.0% |
| `length` | 33 | 50 | 66.0% |
| `random` | 16 | 50 | 32.0% |
...
| `anti_sycophancy` | `direct_combined` | 3 | 10 | 30.0% |
| `anti_sycophancy` | `decomposition_combined` | 3 | 10 | 30.0% |
| `anti_sycophancy` | `direct_category_axis` | 2 | 10 | 20.0% |
| `anti_sycophancy` | `decomposition_category_axis` | 1 | 10 | 10.0% |
...
| `false_premise` | `decomposition_combined` | 3 | 5 | 60.0% |
| `false_premise` | `direct_category_axis` | 2 | 5 | 40.0% |
| `false_premise` | `decomposition_category_axis` | 3 | 5 | 60.0% |
...
| `general_helpfulness` | `direct_category_axis` | 1 | 10 | 10.0% |
...
| `harmful_request` | `direct_category_axis` | 3 | 8 | 37.5% |
| `harmful_request` | `decomposition_category_axis` | 4 | 8 | 50.0% |
...
| `persona_honesty` | `direct_category_axis` | 3 | 10 | 30.0% |
| `persona_honesty` | `decomposition_category_axis` | 4 | 10 | 40.0% |
...
| `privacy_safety` | `decomposition_combined` | 0 | 1 | 0.0% |
| `privacy_safety` | `direct_category_axis` | 1 | 1 | 100.0% |
| `privacy_safety` | `decomposition_category_axis` | 1 | 1 | 100.0% |

## Artifacts

- Scores CSV: `notes/research_cycles/cycle_001_next/pilot_50_fastembed_jina_v2_small/scores.csv`
- Scores JSON: `notes/research_cycles/cycle_001_next/pilot_50_fastembed_jina_v2_small/scores.json`
- Selections CSV: `notes/research_cycles/cycle_001_next/pilot_50_fastembed_jina_v2_small/selections.csv`
- Blind packet: `notes/research_cycles/cycle_001_next/pilot_50_fastembed_jina_v2_small/blind_review_packet.jsonl`
- Blind packet key: `notes/research_cycles/cycle_001_next/pilot_50_fastembed_jina_v2_small/blind_review_packet_key.json`
